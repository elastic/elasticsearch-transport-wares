...
**Repository:** [https://github.com/elasticsearch/elasticsearch-transport-wares](https://github.com/elasticsearch/elasticsearch-transport-wares)
...
```sh
cd elasticsearch-transport-wares/
